...
<div class="yellow-narrow-spacer center">
	<h1><?php echo page('ateliers')->title() ?></h1>
	<h4><?php echo page('ateliers')->subtitle() ?></h4>
</div>
<div class="colour-block cyan-bg bmb"></div>

<div class="container bmb">
	<div clas="row">
	  	<?php foreach (page('ateliers')->children()->visible()->limit(3) as $p) : ?>
	...
	<div class="row center">
		<a href="/ateliers" class="btn btn-theme"><?php echo l::get('all-ateliers') ?></a>
	</div>
</div>
