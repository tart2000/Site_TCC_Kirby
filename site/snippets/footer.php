...
<script type="text/javascript">
    window.cookieconsent_options = {"message":<?php echo l::get('cookie-message') ?>,"dismiss":<?php echo l::get('cookie-dismiss') ?>,"learnMore":<?php echo l::get('cookie-learn-more') ?>,"link":"/en/cookie","theme":"dark-top"};
</script>
